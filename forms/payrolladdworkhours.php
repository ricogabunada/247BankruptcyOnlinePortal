<div class="panel panel-default">
        ...
        <div class="input-group no-margin">
          ...
          <span class="input-group-btn">
            ...
            <div class="fileUpload btn btn-info btn-flat">
              <span>Upload</span>
              <input id="uploadBtn" name="filename" type="file" class="upload" onchange="document.getElementById('uploadFile').value = this.value"/>
            </div>
          </span>
        </div>
      </div>
	...
	<div class="panel-footer">
		<!-- <button type="submit" class="btn btn-green" name="submit">ADD</button> -->
		<input type="submit" name="submit" value="ADD" class="btn btn-green">
	</div>
</div>
...
class User extends UserBase
{
    ...
    protected $errorList = array(
        ...
        16 => 'This Email has already been used.',
    ...
    public function register($info, $activation = false)
    {
        ...
        */
		...
		// if($_SESSION['userData']['data']['GroupID'] != '999'){
		// 	if ($this->isSigned()) {
		// 		$this->log->error(15);
		// 		return false;
		// 	}
        ...
        //Hash Password
        if ($info->Password) {
            $info->Password = $this->hash->generateUserPassword($info, $info->Password);
        }
        ...
        if ($this->table->runQuery($sql, $data)) {
            ...
            $this->lastID = $this->table->getLastInsertedID();
            if ($activation) {
